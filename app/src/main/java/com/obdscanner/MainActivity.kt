...
import com.obdscanner.ui.DtcScreen
import com.obdscanner.ui.FuelScreen
import com.obdscanner.ui.GmScreen
import com.obdscanner.ui.GuideScreen
import com.obdscanner.ui.Good
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Column {
                        Text("OBD Scanner ${BuildConfig.VERSION_NAME}", style = MaterialTheme.typography.titleMedium)
